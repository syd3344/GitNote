...
2. 验证安装 — git
   ...
   ![1725982302190](E:\note box\Git、Github\1725982302190.png)

3. 初始化git仓库（git init） 

   > 把目录变成Git可以管理的仓库，之后会多出来一个  .git 文件夹，此时Box1文件夹就是一个Git仓库了
   >
   > ![1725982843290](E:\note box\Git、Github\1725982843290.png)
   >
...
5. 提交（git commit）
   ...
   >
   > ![1725985382082](E:\note box\Git、Github\1725985382082.png)
   >
   > - 将暂存区的内容提交到当前分支

6. 在未提交前查看修改（git diff）

   > ![1725985640867](E:\note box\Git、Github\1725985640867.png)

7. 查看版本提交记录（git log）

   > ![1725985980393](E:\note box\Git、Github\1725985980393.png)
   >
...
11. 查看/创建分支（git branch）
    ...
    > - 产看当前分支
    >
    > ![1726020591745](E:\note box\Git、Github\1726020591745.png)
    >
    > 
    >
    > - 创建分支
    >
    > ![1726020694752](E:\note box\Git、Github\1726020694752.png)

12. 切换分支( git checkout a )

    > - 切换已有分支
    >
    > ![1726021417272](E:\note box\Git、Github\1726021417272.png)
    >
    > - 创建并切换到该分支
    >
    > ![1726021540528](E:\note box\Git、Github\1726021540528.png)
...
![1725986972866](E:\note box\Git、Github\1725986972866.png)
...
2. 添加SSH配置
   ...
   > ![1726022476074](E:\note box\Git、Github\1726022476074.png)
   >
   > - 生成密钥
   ...
   >   
   >   ![1726038658024](E:\note box\Git、Github\1726038658024.png)
   >   
   > - 配置Github
   >
   >   - 配置
   >     - ![1726039172442](E:\note box\Git、Github\1726039172442.png)
   >   - 测试
   >     - ![1726039083880](E:\note box\Git、Github\1726039083880.png)
   >   - 
...
2. 推送( Push )
   ...
   >     - ![1726043010190](E:\note box\Git、Github\1726043010190.png)
   ...
   >   - 查看当前项目有哪些远程仓库
   >     - git remote -v 
   >     - ![1726040695096](E:\note box\Git、Github\1726040695096.png)
